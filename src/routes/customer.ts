...
import { createCustomer, deleteCustomerById, getAllCustomers, getCustomerById, getCustomerByName, getCustomersByAge, getCustomersByGender, getCustomersByNat, getCustomersByPage, getCustomersByRegisterYear, getCustomesHavePurchased, getNewlyRegisteredCustomers, signInCustomer, updateCustomerById } from '../controllers';
...
router.route('/register').post(signInCustomer);
